...
public class GameView {
    ...
    public static void buscarJogoPorNome() throws ServiceException {
        ...
        displayGameList(jogos, "Nenhum jogo encontrado com '" + term + "'.");
    }
    ...
    public static void listarPorGenero() throws ServiceException {
        ...
        displayGameList(jogos, "Nenhum jogo encontrado para o gênero '" + genre + "'.");
    }
    ...
    public static void listarPorPlataforma() throws ServiceException {
        ...
        displayGameList(jogos, "Nenhum jogo encontrado para a plataforma '" + platform + "'.");
    }
    ...
    public static void listarPorDesenvolvedor() throws ServiceException {
        ...
        displayGameList(jogos, "Nenhum jogo encontrado para o desenvolvedor:'" + dev + "'.");
    }

    public static void displayGameList(List<Game> jogos, String emptyMessage) {
        if (jogos.isEmpty()) {
